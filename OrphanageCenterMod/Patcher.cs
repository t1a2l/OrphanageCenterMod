...
namespace OrphanageCenterMod {
    public static class Patcher {
        private const string HarmonyId = "t1a2l.OrphanageCenterMod";
        ...
        public static void PatchAll() {
            ...
            UnityEngine.Debug.Log("Orphanage Center Mod: Patching...");

            patched = true;

            // Apply your patches here!
            // Harmony.DEBUG = true;
            var harmony = new Harmony("t1a2l.OrphanageCenterMod");
        ...
        public static void UnpatchAll() {
            ...
            UnityEngine.Debug.Log("Orphanage Center Mod: Reverted...");
        }
    }
